...
Import-Csv "D:\VARUN\FNB_ReportPUNE.csv" -Header $headers -Delimiter "|" | Where-Object { $_.BillNo -and $_.BillNo.Trim() -ne "" } | ForEach-Object {
...
Write-Host "PUNE upload completed." (Get-Date).ToString("HH:mm:ss")
Exit