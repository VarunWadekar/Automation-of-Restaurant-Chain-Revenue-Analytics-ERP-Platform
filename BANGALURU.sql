...
+ ISNULL(CAST(RD.tableNo AS VARCHAR),'') AS BillCode,
    ...
    CASE 
        ...
        WHEN UPPER(RD.IncomeHeadDescription) LIKE '%OTHER SERVICES%' THEN 'OTHER SERVICES'
