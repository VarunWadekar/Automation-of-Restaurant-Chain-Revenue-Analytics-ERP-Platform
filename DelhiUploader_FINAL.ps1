...
Import-Csv "D:\VARUN\FNB_ReportDELHI.csv" -Header $headers -Delimiter "|" | Where-Object { $_.BillNo -and $_.BillNo.Trim() -ne "" } | ForEach-Object {
...
$uri = "https://script.google.com/macros/s/AKfycbwgGBbw$$$"
$batchSize = 1500
$total = $data.Count
$chunks = @()
...
Write-Host "DELHI upload completed." (Get-Date).ToString("HH:mm:ss")
Exit